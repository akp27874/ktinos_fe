        ...
        <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 p-6 flex flex-col items-center text-center hover:-translate-y-2" style={{ boxShadow: '0 20px 45px rgba(106,27,154,0.08)' }}>
              <div className="w-12 h-12 rounded-full text-white font-extrabold flex items-center justify-center text-xl mb-5 shadow-md group-hover:scale-110 transition-transform duration-300" style={{ background: `linear-gradient(135deg, ${theme.colors.primary.deepPurple}, ${theme.colors.primary.tealWellness})` }}>1</div>
            ...
            <div className="group rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 p-6 flex flex-col items-center text-center hover:-translate-y-2">
              <div className="w-12 h-12 rounded-full text-white font-extrabold flex items-center justify-center text-xl mb-5 shadow-md group-hover:scale-110 transition-transform duration-300" style={{ background: `linear-gradient(135deg, ${theme.colors.primary.deepPurple}, ${theme.colors.primary.tealWellness})` }}>2</div>
            ...
            {/* Step 3 */}
            <div className="group rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 p-6 flex flex-col items-center text-center hover:-translate-y-2">
              <div className="w-12 h-12 rounded-full text-white font-extrabold flex items-center justify-center text-xl mb-5 shadow-md group-hover:scale-110 transition-transform duration-300" style={{ background: `linear-gradient(135deg, ${theme.colors.primary.deepPurple}, ${theme.colors.primary.tealWellness})` }}>3</div>
              <div className="w-32 h-32 mb-5 flex items-center justify-center">
      ...
      <section className="py-20 px-6 md:px-16" style={{ background: 'linear-gradient(180deg, rgba(155,89,182,0.04), rgba(255,255,255,1))' }}>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="group flex flex-col items-center text-center">
            <div className="relative mb-5"><div className="w-32 h-32 rounded-2xl shadow-xl overflow-hidden border-2 border-white group-hover:shadow-2xl transition-all duration-300"><img src="https://m.media-amazon.com/images/I/51JH7qVV8dL.jpg" alt="Ktinoskare product box" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" /></div><div className="absolute -top-3 -right-3 w-8 h-8 rounded-full text-white text-sm font-bold flex items-center justify-center shadow-lg" style={{ background: `linear-gradient(135deg, ${theme.colors.primary.deepPurple}, ${theme.colors.primary.tealWellness})` }}>1</div></div>
          ...
          <div className="group flex flex-col items-center text-center">
            <div className="relative mb-5"><div className="w-32 h-32 rounded-2xl shadow-xl bg-white flex items-center justify-center border-2 border-white group-hover:shadow-2xl transition-all duration-300"><img src="https://c8.alamy.com/comp/F07102/activate-green-button-isolated-on-white-background-F07102.jpg" alt="Golden retriever with band" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" /><div className="absolute -top-3 -right-3 w-8 h-8 rounded-full text-white text-sm font-bold flex items-center justify-center shadow-lg" style={{ background: `linear-gradient(135deg, ${theme.colors.primary.deepPurple}, ${theme.colors.primary.tealWellness})` }}>2</div></div></div>
          ...
          <div className="group flex flex-col items-center text-center">
            <div className="relative mb-5"><div className="w-32 h-32 rounded-2xl shadow-xl overflow-hidden border-2 border-white group-hover:shadow-2xl transition-all duration-300"><img src="https://images.unsplash.com/photo-1552053831-71594a27632d?w=300&h=300&fit=crop&crop=top" alt="Golden retriever with band" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" /></div><div className="absolute -top-3 -right-3 w-8 h-8 rounded-full text-white text-sm font-bold flex items-center justify-center shadow-lg" style={{ background: `linear-gradient(135deg, ${theme.colors.primary.deepPurple}, ${theme.colors.primary.tealWellness})` }}>3</div></div>
